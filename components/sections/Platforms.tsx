...
export default function Platforms() {
  ...
  return (
    <section ref={sectionRef} id="platforms" className="py-24 relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="section-header text-center mb-16" style={{ opacity: 0 }}>
          ...
          <p className="text-text-muted mt-4 max-w-xl mx-auto">
            Connect all your messaging platforms. Orda unifies every conversation in one intelligent AI agent.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          {platforms.map((platform, i) => (
            <div
              ...
              className="group glass-card rounded-2xl p-6 flex flex-col items-center gap-4 cursor-pointer transition-all duration-300 hover:-translate-y-2"
              style={{ opacity: 0 }}
              onMouseEnter={(e) => {
                const el = e.currentTarget
                el.style.boxShadow = `0 0 40px ${platform.glow}, 0 0 80px ${platform.glow.replace('0.25', '0.1')}`
                el.style.borderColor = platform.color + '30'
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget
                el.style.boxShadow = ''
            ...
            >
              ...
              <span className="text-sm font-medium text-text-muted group-hover:text-text-primary transition-colors duration-200">
                {platform.name}
              </span>
            </div>
          ))}
